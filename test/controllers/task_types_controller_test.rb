...
class TaskTypesControllerTest < ActionController::TestCase
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post :create, task_type: { default_assignee: @task_type.default_assignee, default_due: @task_type.default_due, group: @task_type.group, name: @task_type.name }
    end
  ...
  test "should update task_type" do
    patch :update, id: @task_type, task_type: { default_assignee: @task_type.default_assignee, default_due: @task_type.default_due, group: @task_type.group, name: @task_type.name }
    assert_redirected_to task_type_path(assigns(:task_type))
  end
