...
ActiveRecord::Schema.define(version: 20150724054613) do
  ...
  create_table "billing_plans", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.date     "publish_date"
    t.boolean  "send_flg",     limit: 1,   default: false, null: false
    t.string   "display_name", limit: 255
    t.integer  "lead_id",      limit: 4,                   null: false
  end

  add_index "billing_plans", ["company_id"], name: "index_billing_plans_on_company_id", using: :btree
  ...
  create_table "leads", force: :cascade do |t|
    ...
    t.boolean  "dm_flg",           limit: 1,     default: false
    t.boolean  "contract_flg",     limit: 1,     default: false, null: false
    t.boolean  "mark_flg",         limit: 1
    t.boolean  "nego_flg",         limit: 1
  end
  ...
  create_table "periods", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "resume_flg",    limit: 1,     default: false, null: false
    t.boolean  "report_flg",    limit: 1,     default: false, null: false
    t.string   "google_id",     limit: 255
    t.boolean  "equipment_flg", limit: 1,     default: false, null: false
    t.boolean  "attend_flg",    limit: 1,     default: false, null: false
    t.integer  "user_id",       limit: 4
  end
  ...
  create_table "teachers", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "orientation_flg", limit: 1
    t.boolean  "profile_flg",     limit: 1
    t.boolean  "photo_flg",       limit: 1
    t.boolean  "regist_flg",      limit: 1
    t.boolean  "contract_flg",    limit: 1
